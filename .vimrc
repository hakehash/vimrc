...
if has('eval') "{{{
  ...
  function! s:eskk_initial_pre() abort "{{{
    if g:eskk#use_azik "{{{
      ...
      call t.add_map('cha', 'ちゅうあ')
      call t.add_map('che', 'ちゅうえ')
      call t.add_map('chi', 'ちゅうい')
      call t.add_map('cho', 'ちゅうお')
      call t.add_map('chu', 'ちゅうう')
      call t.add_map('dha', 'づうあ')
      call t.add_map('dhe', 'づうえ')
      call t.add_map('dhi', 'づうい')
      call t.add_map('dho', 'づうお')
      call t.add_map('dhu', 'づうう')
      call t.add_map('sha', 'すうあ')
      call t.add_map('she', 'すうえ')
      call t.add_map('shi', 'すうい')
      call t.add_map('sho', 'すうお')
      call t.add_map('shu', 'すうう')
      call t.add_map('tha', 'つうあ')
      call t.add_map('the', 'つうえ')
      call t.add_map('thi', 'つうい')
      call t.add_map('tho', 'つうお')
      call t.add_map('thu', 'つうう')
      call t.add_map('-', '-')
      call t.add_map('x[', '「')
      call t.add_map('_', '「')
      call t.add_map('z_', '『')
